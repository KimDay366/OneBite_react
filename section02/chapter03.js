...
// + 변수에 담는 것이기 때문에, 추후에 내가 사용 할 때에는 배열 관련 특수문자 []나 {}를 사용하지 않아도 됨
// + 배열의 순서가 중요하고, 객체는 프로퍼티의 이름이 중요함
// + 배열은 순서대로, 객체는 프로퍼티의 이름을 사용해서 값을 찾아서 할당함
...
const funcYY = ({name, love, age, job})=>{
    console.log(`함수에 구조분해 할당 사용하기: ${name}, ${age}, ${love}, ${job}`);
}
